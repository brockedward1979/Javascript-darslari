...
let tovarlar = [
  {kategoriya: "Elektronika", maxsulotlar: ["Telefon", "Noutbuk", "Planshet"]},
  {kategoriya: "Kitoblar", maxsulotlar: ["Matematika", "Fizika", "Ingliz tili"]},
  {kategoriya: "Kiyim", maxsulotlar: ["Kuylak", "Shim", "Futbolka"]},
  {kategoriya: "Sport", maxsulotlar: ["Raketka", "To'p", "Shayba"]}
]



let natija = tovarlar.flatMap((tovar) => {
  return tovar.maxsulotlar
}
)
